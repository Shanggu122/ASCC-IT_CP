// Auto-dismiss field and generic login errors after a delay (default 5s)
...
(function(){
  ...
  function schedule(el){
    ...
    setTimeout(()=>{
      ...
      setTimeout(()=>{ if(el.classList.contains('fade-out-field-error')) el.textContent='\u200B'; }, 420);
    }, DISMISS_MS);
  }
  window.addEventListener('DOMContentLoaded', ()=>{
    document.querySelectorAll('.field-error, .login-error').forEach(schedule);
  });
})();
